...
public class ProxyServletTest
{
  ...
  protected String entryPoint  = ""; // for ProxyServletWithFragmentsTest
  ...
  public void setUp() throws Exception {
    ...
    servletProps.setProperty(ProxyServlet.P_FORWARDED_FOR, "true");
  ...
  private void assertRedirect(GetMethodWebRequest request, String origRedirect, String resultRedirect) throws IOException, SAXException {
    ...
    assertEquals(true, rsp.getHeaderField("Set-Cookie").contains("!Proxy!" + servletName + "JSESSIONID=1234;path=" + servletPath));
  }
  ...
  public void testSendFile() throws Exception {
    ...
    final PostMethodWebRequest request = new PostMethodWebRequest(
            rewriteMakeMethodUrl("http://localhost"+servletPath+entryPoint), true);//true: mime encoded
  ...
  public void testSetCookie() throws Exception {
    ...
    assertEquals(true, rsp.getHeaderField(HEADER).contains("!Proxy!" + servletName + "JSESSIONID=1234;path=" + servletPath));
  }
  ...
  public void testPreserveCookie() throws Exception {
    ...
    servletProps.setProperty(ProxyServlet.P_LOG, "true");
    servletProps.setProperty(ProxyServlet.P_FORWARDED_FOR, "true");
    servletProps.setProperty(ProxyServlet.P_PRESERVE_COOKIES, "true");
    setUpServlet(servletProps);
    ...
    WebResponse rsp = execAndAssert(req, "");
    // note httpunit doesn't set all cookie fields, ignores max-agent, secure, etc.
    assertEquals(true, rsp.getHeaderField(HEADER).contains("JSESSIONID=1234;path=" + servletPath));
  }
  ...
  public void testPreserveHost() throws Exception {
    ...
    servletProps.setProperty(ProxyServlet.P_LOG, "true");
    servletProps.setProperty(ProxyServlet.P_FORWARDED_FOR, "true");
    servletProps.setProperty(ProxyServlet.P_PRESERVE_HOST, "true");
    setUpServlet(servletProps);
